...
AutoCorrect Desktop is designed as a local-first desktop tool. It does not upload your text content to a server.
...
- macOS: `~/Library/Application Support/autocorrect-desktop/`
- Windows: `%APPDATA%/autocorrect-desktop/`
- Linux: `~/.local/share/autocorrect-desktop/`
