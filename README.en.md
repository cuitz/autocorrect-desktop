...
**A local desktop formatter for Chinese text**
...
AutoCorrect Desktop is a local desktop client powered by the bundled [autocorrect](https://github.com/huacnlee/autocorrect) Rust engine. It formats Chinese text by adding spacing between Chinese characters and Latin letters or numbers, and by normalizing punctuation.
...
![AutoCorrect Desktop main window](./docs/images/main-window.png)
...
|---------|------------------|
| Add spaces between Chinese and Latin/numbers | `space-word` |
...
| Convert Chinese punctuation to fullwidth | `fullwidth` |
...
AutoCorrect Desktop is local-first and does not upload your text content.
